...
$db = mysql_connect("localhost", "islandsupport", "stpecnoc");
	...
	<div style="position:absolute;top:0px;left:150px; line-height:12px;"><img border="0" src="../images/stars.gif" /> - <strong>Bay Gardens Hotel</strong><br /><span style=" font-size:10px;">Avg User Rating</span>
</div>
