		...
		$numads= mysql_num_rows($adsget);
			if ($numads == 0) {
				...
				?>
                	...
                	<script type="text/javascript">
						new fadeshow(fadeimagesad4, 225, 125, 0, 2000, 0, "R")
					</script>
                <?php
			}
	?>
		...
		$numads= mysql_num_rows($adsget);
			if ($numads == 0) {
				...
				?>
                	...
                	<script type="text/javascript">
						new fadeshow(fadeimagesad5, 225, 125, 0, 2000, 0, "R")
					</script>
                <?php
			}
	?>
		...
		$numads= mysql_num_rows($adsget);
			if ($numads == 0) {
				...
				?>
                	...
                	<script type="text/javascript">
						new fadeshow(fadeimagesad6, 225, 125, 0, 2000, 0, "R")
					</script>
                <?php
			}
	?>
		...
		$numads= mysql_num_rows($adsget);
			if ($numads == 0) {
				...
				?>
                	...
                	<script type="text/javascript">
						new fadeshow(fadeimagesad7, 225, 125, 0, 2000, 0, "R")
					</script>
                <?php
			}
	?>
		...
		$numads= mysql_num_rows($adsget);
			if ($numads == 0) {
				...
				?>
                	...
                	<script type="text/javascript">
						new fadeshow(fadeimagesad8, 225, 125, 0, 2000, 0, "R")
					</script>
                <?php
			}
	?>
...
<div id="content1" style="position:absolute;left:250px;top:170px;width:528px;height:490px; font-family:Arial, Helvetica, sans-serif; font-size:14px;text-align:justify;">
 ...
 <table cellspacing="5"><tr><td> <p><strong>BAY GARDENS HOTEL</strong><br />
    P.0. Box 1892, Castries<br />
    Tel: (758) 452 8060<br />
    Fax: (758) 452 8059<br />
    E-mail: baygardens@candw.lc<br />
  www.baygardenshotel.com</p></td><td valign="top">
  ...
  <p>This award- winning hotel is situated on the south side of Rodney Bay,  within easy reach of Reduit   Beach, shopping centers,  restaurants and night clubs.&nbsp;&nbsp; The hotel  has 87 air-conditioned rooms. These include the luxurious Croton Suites, each  with terrace or balcony, bathroom, cable television, direct dial telephone voice  mail, data ports, radio,110/220 power outlets and refrigerator.&nbsp; </p>
  <p>Bay   Gardens is popular with  corporate and leisure travelers as well as wedding groups.&nbsp; The hotel has three conference rooms with a  fully &ndash;equipped business center and also offers a car rental service. We also  offer a free shuttle service to our sister property Bay   Gardens Beach  resort where you are entitled to use their facilities. </p>
  <p>For guests who want to relax, in addition to the  restaurant and bar, there are two swimming pools, library, internet caf&eacute;,  wedding gazebo <strong>and WIFI throughout the  property. &nbsp;&nbsp;</strong>We are also 5 minutes  away from the newly opened Treasure Bay<strong> </strong>Casino.  The Bay Gardens has established a reputation for  providing excellent value for money and fine service.&nbsp; Seventy &ndash;five percent of By Gardens guests  are repeat clients.</p>
  
  <p><span style="line-height:20px; font-weight:normal;">
