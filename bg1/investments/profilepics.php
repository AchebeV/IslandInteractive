...
function showwebsite(website) {
	document.getElementById('websiteclose').style.display="block";
	document.getElementById('websiteviewer').style.display="block";
	document.getElementById('websiteviewer').src=website;
}

function hidewebsite() {
	document.getElementById('websiteviewer').style.display="none";
	document.getElementById('websiteclose').style.display="none";
}
...
$admedia1 = '<a href="javascript:;" onclick="showvideo(\''.$adcontenturl.'bosl.flv\')"><img src="'.$adcontenturl.$file1.'.'.$ext1.'" border="0" /></a>';
...
<?php
		...
		/*if ($website=="" || $website == "coming soon" || empty($website) || $website == "na") {
			$infoprint.="";
		} else {
			$infoprint.="Website: <a onclick=\"showwebsite('http://".$website."')\" href='javascript:;'>".$website."</a>";
		}*/
...
<!--<iframe id="websiteviewer" style="position:absolute; top:25px; left:215px; z-index:999; display:none;" width="1025" height="700" border="1">

</iframe>

<div id="websiteclose" style="position:absolute; top:124px; left:26px; z-index:997; display:none; background-color:#FFFFFF; opacity:0.7; filter:alpha(opacity=70); width:157px; height:31px;" onclick="hidewebsite()">
Close Website
</div>-->
...
<div id="videoviewer" style="position:absolute; top:130px; left:262px; z-index:999; display:none;" width="900" height="426" border="1">
<?php
echo "<script type=\"text/javascript\">
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,0,0','width','640','height','426','id','FLVPlayer','src','FLVPlayer_Progressive','flashvars','&MM_ComponentVersion=1&skinName=Clear_Skin_1&streamName=".$adcontenturl."bosl&autoPlay=true&autoRewind=false','quality','high','scale','noscale','name','FLVPlayer','salign','lt','pluginspage','http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash','movie','FLVPlayer_Progressive','wmode','transparent' ); //end AC code 
</script><noscript><object classid=\"clsid:D27CDB6E-AE6D-11cf-96B8-444553540000\" codebase=\"http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,0,0\" width=\"640\" height=\"426\" id=\"FLVPlayer\">
  <param name=\"movie\" value=\"FLVPlayer_Progressive.swf\" />
  <param name=\"salign\" value=\"lt\" />
  <param name=\"quality\" value=\"high\" />
  <param name=\"scale\" value=\"noscale\" />
  <param name=\"wmode\" value=\"transparent\" />
  <param name=\"FlashVars\" value=\"&MM_ComponentVersion=1&skinName=Clear_Skin_1&streamName=".$adcontenturl."bosl&autoPlay=true&autoRewind=false\" />
  <embed src=\"FLVPlayer_Progressive.swf\" flashvars=\"&MM_ComponentVersion=1&skinName=Clear_Skin_1&streamName=".$adcontenturl."bosl&autoPlay=true&autoRewind=false\" quality=\"high\" scale=\"noscale\" width=\"640\" height=\"426\" name=\"FLVPlayer\" salign=\"LT\" type=\"application/x-shockwave-flash\" pluginspage=\"http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash\" wmode=\"transparent\" />
</object></noscript>";
?>
