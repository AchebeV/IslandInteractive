...
<!--<iframe id="pdfviewer" style="position:absolute; top:30px; left:175px; z-index:999" width="900" height="600" border="1" src="test.pdf" type="application/pdf">

</iframe>

<div id="pdfbackground" style="position:absolute; top:0px; left:0px; z-index:999; background-color:#000000; opacity:0.7; filter:alpha(opacity=70); width:100%; height:100%;" onclick="hidepdf()">
