...
<div id="content1" style="position:absolute;left:-2000px;top:170px;width:528px;height:490px; font-family:Times New Roman, Times, serif; font-size:14px;text-align:justify;">
	...
	Hotels are generally considered to be larger establishments with more rooms and amenities than the competition. St.Lucia is full of beautiful hotels that could turn any vacation into the time of your life.  <br />
	<br />
	</span>
	<div id="itemcontent" style="position:absolute;top:100px;left:0px;width:100%;">
	
	<a href="profilepics.php?id=1&bp=hotels" style="text-decoration:none;color:black;" onmousedown="style.color='#CC0000'" onmouseup="style.color='#000000'"><div id="item1" style="position:relative;top:0px;left:0px;width:100%;height:100px;">
...
<a href="profilepics.php?id=2&bp=hotels" style="text-decoration:none;color:black;" onmousedown="style.color='#CC0000'" onmouseup="style.color='#000000'"><div id="item2" style="position:relative;top:0px;left:0px;width:100%;height:100px;">
	...
	<a href="profilepics.php?id=3&bp=hotels" style="text-decoration:none;color:black;" onmousedown="style.color='#CC0000'" onmouseup="style.color='#000000'"><div id="item3" style="position:relative;top:0px;left:0px;width:100%;height:100px;">
