...
<div id="content1" style="position:absolute;left:-2000px;top:170px;width:528px;height:490px; font-family:Times New Roman, Times, serif; font-size:14px;text-align:justify;">
	...
	Guest houses are small, quaint, generally family run establishments that offer the visitor a nice alternative to the busier hotel atmosphere.  <br />
	<br />
	</span>
	<div id="itemcontent" style="position:absolute;top:100px;left:0px;width:100%;">
	
	<a href="profilepics.php?id=4&bp=guesthouses" style="text-decoration:none;color:black;" onmousedown="style.color='#CC0000'" onmouseup="style.color='#000000'"><div id="item1" style="position:relative;top:0px;left:0px;width:100%;height:100px;">
...
<a href="profilepics.php?id=5&bp=guesthouses" style="text-decoration:none;color:black;" onmousedown="style.color='#CC0000'" onmouseup="style.color='#000000'"><div id="item2" style="position:relative;top:0px;left:0px;width:100%;height:100px;">
	<div style="position:absolute;top:0px;left:0px;"><img border="0" src="../images/item_Blue Lagoon1.gif" width="140" height="85" /></div>
	<div style="position:absolute;top:0px;left:150px; line-height:12px;"><img border="0" src="../images/stars.gif" /> - <strong>The Blue Lagoon</strong><br /><span style=" font-size:10px;">Avg User Rating</span>
</div>
	<div style="position:absolute;top:35px;left:150px;">Situated in the Rodney Bay Area with a wonderful view of the Marina tropical sunsets and other beautiful surroundings. Easy walking distance to  beaches and the town of Gros Islet.  </div></div></a>
