...
$thiskioskid="DEMO";
$thiscat="accommodation";
$thissubcat="accommodation – guesthouses";
...
<a href="index.php" onmouseout="MM_swapImgRestore()"onmouseup="MM_swapImgRestore()" onmousedown="MM_swapImage('Image4','','images/but_link1ovr.gif',1)"><img src="images/but_link1.gif" alt="Fancy a Meal?" name="Image4" width="188" height="69" border="0" id="Image4" style="position:absolute;left:0px;top:48px;" /></a>

<a href="hotels.php" onmouseout="MM_swapImgRestore()"onmouseup="MM_swapImgRestore()" onmousedown="MM_swapImage('Image5','','images/but_link2ovr.gif',1)"><img src="images/but_link2.gif" alt="Eating Out" name="Image5" width="188" height="69" border="0" id="Image5" style="position:absolute;left:0px;top:92px;" /></a>

<a href="guesthouses.php" onmouseout="MM_swapImgRestore()"onmouseup="MM_swapImgRestore()" onmousedown="MM_swapImage('Image6','','images/but_link3ovr.gif',1)"><img src="images/but_link3.gif" alt="Eating In" name="Image6" width="188" height="69" border="0" id="Image6" style="position:absolute;left:0px;top:136px;"/></a>

<a href="other.php" onmouseout="MM_swapImgRestore()"onmouseup="MM_swapImgRestore()" onmousedown="MM_swapImage('Image7','','images/but_link4ovr.gif',1)"><img src="images/but_link4.gif" alt="Weekly Recipes" name="Image7" width="188" height="69" border="0" id="Image7" style="position:absolute;left:0px;top:180px;"/></a>
...
$db = mysql_connect("localhost", "islandsupport", "stpecnoc");
				...
				<div id="item'.$j.'" style="position:absolute;top:'.$topstart.'px;left:0px;width:100%;height:100px;">
					...
					<a href="profilepics.php?id='.$itemid.'&bp=index" style="text-decoration:none;color:black;" onmousedown="style.color=\'#CC0000\'" onmouseup="style.color=\'#000000\'">
						<div style="position:absolute;top:0px;left:150px; line-height:12px;">
							...
							<br />
							<!--<span style=" font-size:10px;">Not Yet Rated
							</span>-->
						</div>
	...
	<!--<div id="content1" style="position:absolute;top:80px;left:-2000px;width:100%;">

	<!-- <a href="profilepics.php?id=1&bp=index" style="text-decoration:none;color:black;" onmousedown="style.color='#CC0000'" onmouseup="style.color='#000000'"><div id="item1" style="position:relative;top:0px;left:0px;width:100%;height:100px;">
	<div style="position:absolute;top:0px;left:0px;"><img border="0" src="../images/item_BayGardens1.gif" width="140" height="85" /></div>
	<div style="position:absolute;top:0px;left:150px; line-height:12px;"><img border="0" src="../images/stars.gif" /> - <strong>Demo Kiosk</strong><br /><span style=" font-size:10px;">Avg User Rating</span>
</div>
	<div style="position:absolute;top:35px;left:150px;">Opened in November 1995, Bay Gardens has the enviable distinction of being St. Lucia's top medium-sized hotel, with average year-round occupancy of 80% and up to 70% repeat...  </div></div></a>

<a href="profilepics.php?id=2&bp=index" style="text-decoration:none;color:black;" onmousedown="style.color='#CC0000'" onmouseup="style.color='#000000'"><div id="item2" style="position:relative;top:0px;left:0px;width:100%;height:100px;">
	<div style="position:absolute;top:0px;left:0px;"><img border="0" src="../images/item_BayGardens2.gif" width="140" height="85" /></div>
	<div style="position:absolute;top:0px;left:150px; line-height:12px;"><img border="0" src="../images/stars.gif" /> - <strong>Bay Gardens Beach Resort</strong><br /><span style=" font-size:10px;">Avg User Rating</span>
</div>
	<div style="position:absolute;top:35px;left:150px;">at Rodney Bay Village is a Caribbean 4 Star resort ensuring the ultimate holiday experience. Bay Gardens Beach Resort at Rodney Bay village, is a beautifully landscaped resort on the Famous... </div></div></a>
	
	<a href="profilepics.php?id=3&bp=index" style="text-decoration:none;color:black;" onmousedown="style.color='#CC0000'" onmouseup="style.color='#000000'"><div id="item3" style="position:relative;top:0px;left:0px;width:100%;height:100px;">
	<div style="position:absolute;top:0px;left:0px;"><img border="0" src="../images/item_BayGardens3.gif" width="140" height="85" /></div>
	<div style="position:absolute;top:0px;left:150px; line-height:12px;"><img border="0" src="../images/stars.gif" /> - <strong>Bay Gardens Inn</strong><br /><span style=" font-size:10px;">Avg User Rating</span>
</div>
	<div style="position:absolute;top:35px;left:150px;">This cozy, romantic 33 room hotel is a tropical paradise with a three (3) Diamond Rating.  It is located in St. Lucia's premiere tourist area of Rodney Bay. Spacious modern rooms each...  </div></div></a>
	
	<a href="profilepics.php?id=4&bp=index" style="text-decoration:none;color:black;" onmousedown="style.color='#CC0000'" onmouseup="style.color='#000000'"><div id="item4" style="position:relative;top:0px;left:0px;width:100%;height:100px;">
	<div style="position:absolute;top:0px;left:0px;"><img border="0" src="../images/item_Villa Zandoli1.gif" width="140" height="85" /></div>
	<div style="position:absolute;top:0px;left:150px; line-height:12px;"><img border="0" src="../images/stars.gif" /> - <strong>Villa Zandoli</strong><br /><span style=" font-size:10px;">Avg User Rating</span>
</div>
	<div style="position:absolute;top:35px;left:150px;">Villa Zandoli is a small and affordable guest house located in St. Lucia, only 5 minutes walk from one of the nicest beaches of St. Lucia. Villa Zandoli offers a variety of 5 bedrooms, from... </div></div>
		</a>
        
        </div>

<div id="content2" style="position:absolute;top:80px;left:-2000px;width:100%;">
Second Page
</div>

<div id="content3" style="position:absolute;top:80px;left:-2000px;width:100%;">
Third Page
</div>-->
