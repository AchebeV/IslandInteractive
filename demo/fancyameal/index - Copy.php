...
<div id="content1" style="position:absolute;left:-2000px;top:170px;width:528px;height:490px; font-family:Times New Roman, Times, serif; font-size:14px;text-align:justify;">
	...
	On the island there are many excellent choices for dining and cuisine. St. Lucia is home to restaurants whose menus specialize in local and international recipes, and offer romantic , sophisticated ambience to enhance casual dining. Be sure to check out our dining guide for all information on these restaurants.
 <br />
	<br />
	</span>
...
<a href="profilepics.php?id=13" style="text-decoration:none;color:black;" onmousedown="style.color='#CC0000'" onmouseup="style.color='#000000'"><div id="item2" style="position:relative;top:0px;left:0px;width:100%;height:100px;">
	...
	<div style="position:absolute;top:0px;left:0px;"><img border="0" src="../images/item_Recipie1.gif" /></div>
	<div style="position:absolute;top:0px;left:150px; line-height:12px;"><img border="0" src="../images/stars.gif" /> - <strong>Baked Stuffed Breadfruit </strong><br /><span style=" font-size:10px;">Avg User Rating</span>
</div>
	<div style="position:absolute;top:35px;left:150px;">Parboil breadfruit in salted water. Sauté onion, garlic and chives in oil, add meats and lightly fry, add tomato, salt and pepper. Peel and core the breadfruit, fill with mixture... </div></div></a>
...
<a href="javascript:;" style="text-decoration:none;color:black;" onmousedown="style.color='#CC0000'" onmouseup="style.color='#000000'"><div id="item4" style="position:relative;top:0px;left:0px;width:100%;height:100px;">
	<div style="position:absolute;top:0px;left:0px;"><img border="0" src="../images/item_Recipie2.gif" /></div>
	<div style="position:absolute;top:0px;left:150px; line-height:12px;"><img border="0" src="../images/stars.gif" /> - <strong>Green fig & Salt Fish Pie </strong><br /><span style=" font-size:10px;">Avg User Rating</span>
</div>
	<div style="position:absolute;top:35px;left:150px;">Boil the green figs until tender. Peel and crush with fork while still hot and sprinkle with lime juice to prevent darkening. Soak the fish in boiling water to remove most of the salt </div></div></a>
		</div>
