...
$thiskioskid="PROTO";
$thiscat="explore";
$thissubcat="explorestlucia - inthesky";
...
$db = mysql_connect("localhost", "islandsupport", "stpecnoc");
		mysql_select_db("islandsupport",$db);
		$codeget = mysql_query("SELECT * FROM `advertisers` WHERE `section`='$thiscat' AND `subsection`='explorestlucia - inthesky' ORDER BY `paystatus` ASC, `company` ASC",$db);
