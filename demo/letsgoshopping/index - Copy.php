...
<div id="content1" style="position:absolute;left:-2000px;top:170px;width:528px;height:490px; font-family:Times New Roman, Times, serif; font-size:14px;text-align:justify;">
	...
	While staying in St. Lucia shopping is certainly one of the most joyous things to do. St. Lucia offers shoppers a range of duty free stores as well as local and designer stores, perfumes, crystals and a variety of local handicrafts. Be sure to check out our island products section, where you can purchase our local crafts, as well as select duty free items. <br />
	<br />
	</span>
	
	<div id="itemcontent" style="position:absolute;top:100px;left:0px;width:100%;">
	<a href="profilepics.php?id=20" style="text-decoration:none;color:black;" onmousedown="style.color='#CC0000'" onmouseup="style.color='#000000'"><div id="item1" style="position:relative;top:0px;left:0px;width:100%;height:100px;">
	<div style="position:absolute;top:0px;left:0px;"><img border="0" src="../images/item_pointseraphine1.gif" /></div>
	<div style="position:absolute;top:0px;left:150px; line-height:12px;"><img border="0" src="../images/stars.gif" /> - <strong>Pointe Seraphine</strong><br /><span style=" font-size:10px;">Avg User Rating</span>
</div>
	<div style="position:absolute;top:35px;left:150px;">Conveniently located within walking distance of the city of Castries, Duty Free Pointe Seraphine consists of shops offering silk screened items, porcelain and china... </div></div></a>

<a href="profilepics.php?id=21" style="text-decoration:none;color:black;" onmousedown="style.color='#CC0000'" onmouseup="style.color='#000000'"><div id="item2" style="position:relative;top:0px;left:0px;width:100%;height:100px;">
	<div style="position:absolute;top:0px;left:0px;"><img border="0" src="../images/item_Laplace.gif" /></div>
	...
	<div style="position:absolute;top:35px;left:150px;">La Place Carenage Duty Free Shopping Centre replaces what used to be an old cargo shed.  A blend of innovation, island architecture and service excellence, combine to make...  </div></div></a>
	
	<a href="profilepics.php?id=22" style="text-decoration:none;color:black;" onmousedown="style.color='#CC0000'" onmouseup="style.color='#000000'"><div id="item3" style="position:relative;top:0px;left:0px;width:100%;height:100px;">
	<div style="position:absolute;top:0px;left:0px;"><img border="0" src="../images/item_JQ.gif" /></div>
	<div style="position:absolute;top:0px;left:150px; line-height:12px;"><img border="0" src="../images/stars.gif" /> - <strong>JQ Shopping Mall</strong><br /><span style=" font-size:10px;">Avg User Rating</span>
</div>
	<div style="position:absolute;top:35px;left:150px;">JQ Charles Mall is St. Lucia's premier shopping centre, boasting over fifty of the finest quality shops and services in air-conditioned comfort. Our wide range includes... </div></div></a>
