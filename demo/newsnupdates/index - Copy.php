...
?>  MM_preloadImages('../images/but_inthenewsovr.gif','../images/but_lucianpplovr.gif','../images/but_ilupdatesovr.gif','../images/but_homeovr.gif','../images/but_welcomeovr.gif','../images/but_newsovr.gif','../images/but_loginovr.gif','../images/but_registerovr.gif','../images/but_learnmoreovr.gif','../images/button_nextovr.gif','../images/button_backovr.gif');loaderHide()">
...
<div id="content1" style="position:absolute;left:-2000px;top:170px;width:528px;height:490px; font-family:Times New Roman, Times, serif; font-size:14px;text-align:justify;">
	...
	Need to keep up to date with current events? This section is all about bringing you the latest news stories as they unfold. <br />
	<br />
	</span>
	
	<div id="itemcontent" style="position:absolute;top:100px;left:0px;width:100%;">
	
	<a href="profilepics.php?id=6" style="text-decoration:none;color:black;" onmousedown="style.color='#CC0000'" onmouseup="style.color='#000000'"><div id="item1" style="position:relative;top:0px;left:0px;width:100%;height:100px;">
	<div style="position:absolute;top:0px;left:0px;"><img border="0" src="../images/item_SirJohn.gif" /></div>
	<div style="position:absolute;top:0px;left:150px; line-height:12px;"><img border="0" src="../images/stars.gif" /> - <strong>Sir John Compton</strong><br /><span style=" font-size:10px;">Avg User Rating</span>
</div>
	<div style="position:absolute;top:35px;left:150px;">Sir John George Melvin Compton, (25th April 1925 - 7th September 2007)  was the last among the pantheon of the great visionary political leaders of the Caribbean, among them... </div></div></a>

<a href="profilepics.php?id=7" style="text-decoration:none;color:black;" onmousedown="style.color='#CC0000'" onmouseup="style.color='#000000'"><div id="item2" style="position:relative;top:0px;left:0px;width:100%;height:100px;">
	<div style="position:absolute;top:0px;left:0px;"><img border="0" src="../images/item_SirArthur.gif" /></div>
	<div style="position:absolute;top:0px;left:150px; line-height:12px;"><img border="0" src="../images/stars.gif" /> - <strong>Sir Arthur Lewis</strong><br /><span style=" font-size:10px;">Avg User Rating</span>
</div>
	<div style="position:absolute;top:35px;left:150px;">Born in St. Lucia on January 23, 1915, fourth son of George Ferdinand and Ida Lewis. Arthur Lewis in 1947 married Gladys Jacobs and had two daughters, Elizabeth and Barbara...</div></div></a>
	
	<a href="profilepics.php?id=8" style="text-decoration:none;color:black;" onmousedown="style.color='#CC0000'" onmouseup="style.color='#000000'"><div id="item3" style="position:relative;top:0px;left:0px;width:100%;height:100px;">
	<div style="position:absolute;top:0px;left:0px;"><img border="0" src="../images/item_DWalcott1.gif" /></div>
	<div style="position:absolute;top:0px;left:150px; line-height:12px;"><img border="0" src="../images/stars.gif" /> - <strong>Derek Walcott</strong><br /><span style=" font-size:10px;">Avg User Rating</span>
</div>
	<div style="position:absolute;top:35px;left:150px;">Derek Walcott was born in 1930 in the town of Castries in Saint Lucia. The experience of growing up on the isolated volcanic island, an ex-British colony, has had a strong influence...  </div></div></a>
		</div>
