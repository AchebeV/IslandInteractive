...
<div id="content1" style="position:absolute;left:-2000px;top:170px;width:528px;height:490px; font-family:Times New Roman, Times, serif; font-size:14px;text-align:justify;">
	...
	Real Estate in St. Lucia is definitely a hot commodity that is steadily gaining more and more popularity. From condos and villas to land and houses, St.Lucia offers you beauty, comfort and style all in one sweet cool package. Let Island Interactive be the one to help you purchase your new home in paradise. <br />
	<br />
	</span>
	...
	<a href="profilepics.php?id=27" style="text-decoration:none;color:black;" onmousedown="style.color='#CC0000'" onmouseup="style.color='#000000'"><div id="item1" style="position:relative;top:0px;left:0px;width:100%;height:100px;">
	<div style="position:absolute;top:0px;left:0px;"><img border="0" src="../images/item_oceanBreeze2.gif" /></div>
	<div style="position:absolute;top:0px;left:150px; line-height:12px;"><img border="0" src="../images/stars.gif" /> - <strong>Ocean Breeze </strong><br /><span style=" font-size:10px;">Avg User Rating</span>
</div>
	<div style="position:absolute;top:35px;left:150px;">'On behalf of our personnel involved in creating this residential complex; we welcome you to our dream.  We hope by purchasing this piece of real estate... </div></div></a>
	
	<a href="profilepics.php?id=28" style="text-decoration:none;color:black;" onmousedown="style.color='#CC0000'" onmouseup="style.color='#000000'"><div id="item2" style="position:relative;top:0px;left:0px;width:100%;height:100px;">
	<div style="position:absolute;top:0px;left:0px;"><img border="0" src="../images/item_TropicalVillas.gif" /></div>
	<div style="position:absolute;top:0px;left:150px; line-height:12px;"><img border="0" src="../images/stars.gif" /> - <strong>Tropical Villas </strong><br /><span style=" font-size:10px;">Avg User Rating</span>
</div>
	<div style="position:absolute;top:35px;left:150px;">Tropical Villas are exclusive, luxury St Lucia properties catering to the discerning visitor who prefers personalised service and values privacy. A  We manage numerous...  </div></div></a>

<a href="profilepics.php?id=29" style="text-decoration:none;color:black;" onmousedown="style.color='#CC0000'" onmouseup="style.color='#000000'"><div id="item3" style="position:relative;top:0px;left:0px;width:100%;height:100px;">
	<div style="position:absolute;top:0px;left:0px;"><img border="0" src="../images/item_Sunswept.gif" /></div>
	<div style="position:absolute;top:0px;left:150px; line-height:12px;"><img border="0" src="../images/stars.gif" /> - <strong>Sunswept Estates</strong><br /><span style=" font-size:10px;">Avg User Rating</span>
</div>
	<div style="position:absolute;top:35px;left:150px;">are experts in St Lucian real estate. With extensive experience and knowledge in the island's development over the last 30 years, Sunswept Estates can offer sound advice...  </div></div></a>
	
	<a href="profilepics.php?id=30" style="text-decoration:none;color:black;" onmousedown="style.color='#CC0000'" onmouseup="style.color='#000000'"><div id="item4" style="position:relative;top:0px;left:0px;width:100%;height:100px;">
	<div style="position:absolute;top:0px;left:0px;"><img border="0" src="../images/item_bellevue.gif"/></div>
	<div style="position:absolute;top:0px;left:150px; line-height:12px;"><img border="0" src="../images/stars.gif" /> - <strong>Belle Vue</strong><br /><span style=" font-size:10px;">Avg User Rating</span>
</div>
	<div style="position:absolute;top:35px;left:150px;">Belle Vue Properties Limited offers Private Luxury villas in St. Lucia. Exquisitely detailed villas in St. Lucia have helped make the island the top luxury tourist destination.</div></div></a>
