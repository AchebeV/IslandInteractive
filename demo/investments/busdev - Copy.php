...
<div id="content1" style="position:absolute;left:-2000px;top:170px;width:528px;height:490px; font-family:Times New Roman, Times, serif; font-size:14px;text-align:justify;">
	...
	The business sector in St. Lucia is booming and ready for capital investment. Let our team of market annalists help you make the right decision, one that is suited to your budget and personality. A monetary investment in local business will contribute to the development of our local economy.   <br />
	<br />
	</span>
	...
	<a href="profilepics.php?id=31" style="text-decoration:none;color:black;" onmousedown="style.color='#CC0000'" onmouseup="style.color='#000000'"><div id="item1" style="position:relative;top:0px;left:0px;width:100%;height:100px;">
	<div style="position:absolute;top:0px;left:0px;"><img border="0" src="../images/item_SunnyTraders.gif" /></div>
	<div style="position:absolute;top:0px;left:150px; line-height:12px;"><img border="0" src="../images/stars.gif" /> - <strong>Sunny Traders</strong><br /><span style=" font-size:10px;">Avg User Rating</span>
</div>
	<div style="position:absolute;top:35px;left:150px;">Sunny Traders is the only educational site in St. Lucia and the Caribbean to promote the benefits of online securities trading as a profession or hobby to the general public...  </div></div></a>

<a href="profilepics.php?id=32" style="text-decoration:none;color:black;" onmousedown="style.color='#CC0000'" onmouseup="style.color='#000000'"><div id="item2" style="position:relative;top:0px;left:0px;width:100%;height:100px;">
	<div style="position:absolute;top:0px;left:0px;"><img border="0" src="../images/item_Fancyfoods.gif" /></div>
	<div style="position:absolute;top:0px;left:150px; line-height:12px;"><img border="0" src="../images/stars.gif" /> - <strong>Fancy Foods </strong><br /><span style=" font-size:10px;">Avg User Rating</span>
</div>
	<div style="position:absolute;top:35px;left:150px;">Fancy Foods is the latest addition to the list of wholesale distributors in St. Lucia. We have been doing business since February 2007 and are currently the agents for... </div></div></a>
	
	<a href="profilepics.php?id=33" style="text-decoration:none;color:black;" onmousedown="style.color='#CC0000'" onmouseup="style.color='#000000'"><div id="item3" style="position:relative;top:0px;left:0px;width:100%;height:100px;">
	<div style="position:absolute;top:0px;left:0px;"><img border="0" src="../images/item_MusicMan.gif" /></div>
	<div style="position:absolute;top:0px;left:150px; line-height:12px;"><img border="0" src="../images/stars.gif" /> - <strong>Music Man </strong><br /><span style=" font-size:10px;">Avg User Rating</span>
</div>
	<div style="position:absolute;top:35px;left:150px;">The musician's friend in Marisule, is St. Lucia's only full-line music store, committed to meeting the needs of musicians - at whatever age or stage. We carry a wide... </div></div></a>
