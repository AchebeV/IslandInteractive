...
<div id="content1" style="position:absolute;left:-2000px;top:170px;width:528px;height:490px; font-family:Times New Roman, Times, serif; font-size:14px;text-align:justify;">
	...
	St. Lucia is home to a wealth of financial institutions, that have the most convenient locations and personnel that can assist you with any banking needs that you may have. So should you need to change currency, send or receive money, make a credit card payment or require offshore banking services feel free to contact a representative at an institution and I am sure they will be happy to assist you. <br />
	<br />
	</span>
	...
	<a href="profilepics.php?id=23" style="text-decoration:none;color:black;" onmousedown="style.color='#CC0000'" onmouseup="style.color='#000000'"><div id="item1" style="position:relative;top:0px;left:0px;width:100%;height:100px;">
	<div style="position:absolute;top:0px;left:0px;"><img border="0" src="../images/item_BankofSLU.gif" /></div>
	<div style="position:absolute;top:0px;left:150px; line-height:12px;"><img border="0" src="../images/stars.gif" /> - <strong>Bank Of St. Lucia </strong><br /><span style=" font-size:10px;">Avg User Rating</span>
</div>
	<div style="position:absolute;top:35px;left:150px;">Bank of Saint Lucia is Saint Lucia's leading Banking institution. A member of the ECFH Group of companies, the Bank offers Personal and Commercial banking...  </div></div></a>

<a href="profilepics.php?id=24" style="text-decoration:none;color:black;" onmousedown="style.color='#CC0000'" onmouseup="style.color='#000000'"><div id="item2" style="position:relative;top:0px;left:0px;width:100%;height:100px;">
	<div style="position:absolute;top:0px;left:0px;"><img border="0" src="../images/item_1stNational1.gif" /></div>
	<div style="position:absolute;top:0px;left:150px; line-height:12px;"><img border="0" src="../images/stars.gif" /> - <strong>1st National Bank</strong><br /><span style=" font-size:10px;">Avg User Rating</span>
</div>
	<div style="position:absolute;top:35px;left:150px;">With the re-imaging of the Bank having taken place this early in the millennium, our "enduring and important institution" still calls St. Lucians and extended global families... </div></div></a>
	
	<a href="profilepics.php?id=25" style="text-decoration:none;color:black;" onmousedown="style.color='#CC0000'" onmouseup="style.color='#000000'"><div id="item3" style="position:relative;top:0px;left:0px;width:100%;height:100px;">
	<div style="position:absolute;top:0px;left:0px;"><img border="0" src="../images/item_FirstCaribbean1.gif" /></div>
	<div style="position:absolute;top:0px;left:150px; line-height:12px;"><img border="0" src="../images/stars.gif" /> - <strong>First Caribbean</strong><br /><span style=" font-size:10px;">Avg User Rating</span>
</div>
	<div style="position:absolute;top:35px;left:150px;">FirstCaribbean is a major Caribbean bank offering a full range of market-leading financial services in Corporate Banking, Retail Banking, Wealth Management, Credit Cards... </div></div></a>
	
	<a href="profilepics.php?id=26" style="text-decoration:none;color:black;" onmousedown="style.color='#CC0000'" onmouseup="style.color='#000000'"><div id="item4" style="position:relative;top:0px;left:0px;width:100%;height:100px;">
	<div style="position:absolute;top:0px;left:0px;"><img border="0" src="../images/item_RoyalBank1.gif" /></div>
	<div style="position:absolute;top:0px;left:150px; line-height:12px;"><img border="0" src="../images/stars.gif" /> - <strong>Royal Bank Of Canada</strong><br /><span style=" font-size:10px;">Avg User Rating</span>
</div>
	<div style="position:absolute;top:35px;left:150px;">RBC has had strong roots in the Eastern Caribbean from as far back as 1915 when branches were established in Dominica, Antigua and St Kitts. </div></div></a>
		</div>
