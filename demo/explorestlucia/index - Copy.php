...
<div id="content1" style="position:absolute;left:-2000px;top:170px;width:528px;height:490px; font-family:Times New Roman, Times, serif; font-size:14px;text-align:justify;">
	...
	There is a wide variety of opportunities to tour St. Lucia's outstanding natural attractions. Here you can find all the activities that will make your stay a memorable one. There are many ways to explore what the island has to offer. You can explore by land, sea and even air. Use the navigation buttons on the left to choose the best way for you to explore the island.<br />
	<br /><br />
	</span>
	
	<div id="itemcontent" style="position:absolute;top:100px;left:0px;width:100%;">
	
	<a href="profilepics.php?id=16" style="text-decoration:none;color:black;" onmousedown="style.color='#CC0000'" onmouseup="style.color='#000000'"><div id="item1" style="position:relative;top:0px;left:0px;width:100%;height:100px;">
	<div style="position:absolute;top:0px;left:0px;"><img border="0" src="../images/item_sunlink.gif" /></div>
	<div style="position:absolute;top:0px;left:150px; line-height:12px;"><img border="0" src="../images/stars.gif" /> - <strong>SunLink Tours </strong><br /><span style=" font-size:10px;">Avg User Rating</span>
</div>
	<div style="position:absolute;top:35px;left:150px;">SunLink Tours is the tours division of St.Lucia Representative Services, a St.Lucian owned ground handling company established in 1976. SunLink tours has a dedicated team of highly... </div></div></a>

<a href="profilepics.php?id=17" style="text-decoration:none;color:black;" onmousedown="style.color='#CC0000'" onmouseup="style.color='#000000'"><div id="item2" style="position:relative;top:0px;left:0px;width:100%;height:100px;">
	<div style="position:absolute;top:0px;left:0px;"><img border="0" src="../images/item_jungletours1.gif" /></div>
	<div style="position:absolute;top:0px;left:150px; line-height:12px;"><img border="0" src="../images/stars.gif" /> - <strong>Jungle Tours </strong><br /><span style=" font-size:10px;">Avg User Rating</span>
</div>
	<div style="position:absolute;top:35px;left:150px;">The Original Rainforest Experience. If you like the outdoors and you want to experience the island of St.Lucia away from the beaten track - we have the right tours... </div></div></a>
	
	<a href="profilepics.php?id=18" style="text-decoration:none;color:black;" onmousedown="style.color='#CC0000'" onmouseup="style.color='#000000'"><div id="item3" style="position:relative;top:0px;left:0px;width:100%;height:100px;">
	<div style="position:absolute;top:0px;left:0px;"><img border="0" src="../images/item_waveriders.gif" /></div>
	<div style="position:absolute;top:0px;left:150px; line-height:12px;"><img border="0" src="../images/stars.gif" /> - <strong>St. Lucia Wave Riders </strong><br /><span style=" font-size:10px;">Avg User Rating</span>
</div>
	<div style="position:absolute;top:35px;left:150px;">The West Indies are like no other place in the world for island hopping. With their unique history and recent past, the Caribbean islands present a rich diversity of cultures... </div></div></a>
	
		
	<a href="profilepics.php?id=19" style="text-decoration:none;color:black;" onmousedown="style.color='#CC0000'" onmouseup="style.color='#000000'"><div id="item4" style="position:relative;top:0px;left:0px;width:100%;height:100px;">
