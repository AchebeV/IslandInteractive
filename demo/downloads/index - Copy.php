...
<a href="audio.php" onmouseout="MM_swapImgRestore()"onmouseup="MM_swapImgRestore()" onmousedown="MM_swapImage('Image5','','images/but_link2ovr.gif',1)"><img src="images/but_link2.gif" alt="Island Festivals" name="Image5" width="188" height="69" border="0" id="Image5" style="position:absolute;left:0px;top:92px;" /></a>

<a href="video.php" onmouseout="MM_swapImgRestore()"onmouseup="MM_swapImgRestore()" onmousedown="MM_swapImage('Image6','','images/but_link3ovr.gif',1)"><img src="images/but_link3.gif" alt="Up &amp; Coming Events" name="Image6" width="188" height="69" border="0" id="Image6" style="position:absolute;left:0px;top:136px;"/></a>

<a href="other.php" onmouseout="MM_swapImgRestore()"onmouseup="MM_swapImgRestore()" onmousedown="MM_swapImage('Image7','','images/but_link4ovr.gif',1)"><img src="images/but_link4.gif" alt="Local Clubs" name="Image7" width="188" height="69" border="0" id="Image7" style="position:absolute;left:0px;top:180px;"/></a>
...
<div id="content1" style="position:absolute;left:-2000px;top:170px;width:528px;height:490px; font-family:Times New Roman, Times, serif; font-size:14px;text-align:justify;">
	...
	Welcome to the download section. Unlike those other sites that just provide old fashion information, here you can find many cool and interesting island things to download. You can download sample music from various local artists, screen savers, wallpapers and even cell phone ring tones.<br />
	<br />
	</span>
	<!--<div id="uc" style="position:absolute;top:100px;left:0px;width:100%;text-align:center;"><img src="../images/uc.gif" /></div>-->
	<div id="itemcontent" style="position:absolute;top:100px;left:0px;width:100%;">
<a href="profilepics.php?id=34" style="text-decoration:none;color:black;" onmousedown="style.color='#CC0000'" onmouseup="style.color='#000000'"><div id="item1" style="position:relative;top:0px;left:0px;width:100%;height:100px;">
	<div style="position:absolute;top:0px;left:0px;"><img border="0" src="../images/item_Main2.gif" /></div>
	<div style="position:absolute;top:0px;left:150px; line-height:12px;"><img border="0" src="../images/stars.gif" /> - <strong>Qshandeya</strong><br /><span style=" font-size:10px;">Avg User Rating</span>
</div>
	<div style="position:absolute;top:35px;left:150px;">"JAH HUMBLE SERVANT" Qshan Deya (Kellis Quashie) is a self-taught musician, producer, songwriter and singer who has come to uplift and mesmerize the ... </div></div></a>

<a href="profilepics.php?id=35" style="text-decoration:none;color:black;" onmousedown="style.color='#CC0000'" onmouseup="style.color='#000000'"><div id="item2" style="position:relative;top:0px;left:0px;width:100%;height:100px;">
	<div style="position:absolute;top:0px;left:0px;"><img border="0" src="../images/item_DownloadsContent2.gif" /></div>
	<div style="position:absolute;top:0px;left:150px; line-height:12px;"><img border="0" src="../images/stars.gif" /> - <strong>Radio St. Lucia</strong><br /><span style=" font-size:10px;">Avg User Rating</span>
</div>
	<div style="position:absolute;top:35px;left:150px;">Popularly known as "The Nation's Station" RSL is mandated to provide public service broadcasting, although earning its keep from advertising.  </div></div></a>
	...
	<div style="position:absolute;top:0px;left:0px;"><img border="0" src="../images/item_DownloadsContent3.gif" /></div>
	<div style="position:absolute;top:0px;left:150px; line-height:12px;"><img border="0" src="../images/stars.gif" /> - <strong>The Wave</strong><br /><span style=" font-size:10px;">Avg User Rating</span>
</div>
	<div style="position:absolute;top:35px;left:150px;">It happens only on St lucia's music leader with rhythm and sole.The Wave 94.5 & 93.7. It's the sound that stirs the masses. It's a station that has been created... </div></div></a>
