...
} else if ($itemid=="198437") {
$admedia1 = '<a href="javascript:;" onclick="showpdf(\''.$adcontenturl.'ChefXavAbout.pdf\')"><img src="'.$adcontenturl.$file1.'.'.$ext1.'" border="0" /></a>';
} else if ($itemid=="1984371") {
$admedia1 = '<a href="javascript:;" onclick="showpdf(\''.$adcontenturl.'eleganceabout.pdf\')"><img src="'.$adcontenturl.$file1.'.'.$ext1.'" border="0" /></a>';
} else if ($itemid=="2271465") {
$admedia1 = '<a href="javascript:;" onclick="showvideo(\''.$adcontenturl.'orlandos.flv\')"><img src="'.$adcontenturl.$file1.'.'.$ext1.'" border="0" /></a>';
...
$admedia2 = '<a href="javascript:;" onclick="showpdf(\''.$adcontenturl.'ChefXavMenu.pdf\')"><img src="'.$adcontenturl.$file2.'.'.$ext2.'" border="0" /></a>';
} else if ($itemid=="1984371") {
$admedia2 = '<a href="javascript:;" onclick="showpdf(\''.$adcontenturl.'eleganceallmenus.pdf\')"><img src="'.$adcontenturl.$file2.'.'.$ext2.'" border="0" /></a>';
} else if ($itemid=="2271465") {
$admedia2 = '<a href="javascript:;" onclick="showpdf(\''.$adcontenturl.'orlandos_pdf.pdf\')"><img src="'.$adcontenturl.$file2.'.'.$ext2.'" border="0" /></a>';
