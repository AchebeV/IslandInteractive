...
<div id="content1" style="position:absolute;left:250px;top:170px;width:528px;height:490px; font-family:Arial, Helvetica, sans-serif; font-size:14px;text-align:justify;">
  ...
  <span style="line-height:20px; font-weight:normal;"><span class="style1">Dear Valued Guest</span><br />
  <br />

Welcome<br />
<br />

A warm St. Lucian welcome awaits you at IGY's Rodney Bay Marina, with a staff that is committed to making your visit memorable and enjoyable. Guests can preregister for a speedy check-in and repeat guests at IGY properties are quickly recognized.
<br />
<br />
Rodney Bay Marina is located on the northwest shore of St. Lucia, one of the most beautiful islands in the Caribbean. Well-protected from weather and winds, Rodney Bay Marina has long provided secure berthing through all weather conditions. Martinique is just 21 miles to the
north and the Grenadines provide spectacular cruising to the south.
<br />
<br />
As an official port of entry to St. Lucia, Rodney Bay Marina offers an on-site customs and immigration office. Yachts arriving from foreign ports can clear in and out of St. Lucia from its designated berth at the Rodney Bay Marina.
<br />
<br />
You will quickly make friends with your fellow cruisers. We have a distinctly international clientele, with regular visitors from the Americas, Europe and elsewhere. The bars and restaurants on site provide casual settings for fun and relaxation. Additionally, we offer periodic barbecues and cocktail receptions for our guests.
<br />
<br />
...
All of this makes Rodney Bay Marina not just another berth, but truly a "home away from home" for visiting yachts. If there is anything that we can do to make your stay with us more memorable and relaxing please do not hesitate to ask.
<br />
<br /><br />
Sincerely,<br />
<strong>Simon Bryan <br />
General Manager<br /></strong>
Sbryan@igymarinas.com<br />
<br />
<div align="left"><strong>KEY IGY MARINA TEAM<br /></strong></div>
...
General Manager<br />
+1 758-572 7200<br />
afoster@igymarinas.com<br />
<br />
Alana Mathurin <br />
Marketing, Sales & Events Manager<br />
+1 758-572 7200  <br />
Amathurin@igymarinas.com <br />
<br />
Pet Antoine<br />
Marina Office<br />
+1 758-572 7200  <br />
pantoine@igymarinas.com<br />

</td>
    <td valign="top">Kenneth Mathurin<br />
Marina Broker<br />
+1 758-717 8139<br />
kmathurin@igymarinas.com<br />
<br />
Natalie Marcel<br />
Marina Office<br />
+1 758-572 7200  <br />
nmarcel@igymarinas.com<br />
<br />

For reservations please contact Natalie
Marcel.
</td>
  </tr>
</table>
...
<div id="content3" style="position:absolute;left:-2000px;top:170px;width:528px;height:490px; font-family:Arial, Helvetica, sans-serif; font-size:14px;text-align:justify; text-align:center;"><br />

   <img src="http://localhost/islandintsyncs/adimages/IGY Pg 2.gif" alt="IGY Map" />

</div>

<div id="content4" style="position:absolute;left:-2000px;top:170px;width:528px;height:490px; font-family:Arial, Helvetica, sans-serif; font-size:14px;text-align:justify; text-align:justify;"><br />
<br />
   <strong>Customer feedback form</strong>
<br />
<br />
Island Global Yachting is committed to providing superior customer service and we welcome all feedback. Please find printed survey's in the marina office, or alternatively <a href="javascript:;" onclick="shownewsletter()">please click here for our feedback form</a>.
<br />
<br />
Advance reservations are strongly recommended at Rodney Bay Marina and we cannot guarantee available berthing for guests arriving without a reservation. We also ask
that you provide advance notice, where feasible, of your approximate arrival time so that we can be fully prepared for your arrival and minimize any inconvenience to you.
<br />
<br />
Upon arrival at the marina, you will be met at your slip by our dock attendants to guide you in and assist you with docking. Once you are comfortably settled into your slip, we ask that you visit our marina office in order to check in. Our office staff will quickly register you and answer any questions that you may have about Rodney bay Marina and St. Lucia, including assistance in arranging your entertainment and activities on land.
...
<div id="content5" style="position:absolute;left:-2000px;top:170px;width:528px;height:490px; font-family:Arial, Helvetica, sans-serif; font-size:14px;text-align:justify; text-align:justify;">
<strong>Check In/Out Times</strong>
<br />
<br />
Check-in time is at 8:00am eastern, while check out time is at 12:00pm
<br />
<br />
If you are arriving after office hours please contact Rodney Bay Security on VHF Channel 16 for assistance.
<br />
<br />
<strong>ARRIVAL & DEPARTURE PROCEDURES</strong>
<br />
<br />
In order to clear into Rodney Bay Marina, the immigration officer will need the following:
<br />
<ul><li>Copy of passenger and crew list (*4)</li><li>
Passports of all crew and guest</li><li>
Clearance form from last port</li><li>
A copy of the ship's registry</li></ul>
A Caribbean pre-arrival notification system is at www.sailclear.com and has a list of participating countries. The Immigration, Customs and St. Lucia Air & Sea Ports Authority are housed in the same unit, making it a one-stop shop. The clearance is valid for 72 hours.
<br />
<br />
<strong>Port Offices</strong>
<br />
<br />
Customs & Excise Dept +1 758 452 0235<br />
Customs & Excise Dept (Main Office Castries) +1 758 468 4800<br />
Immigration & Seaport Authority +1 758 452 0548<br />
...
function shownewsletter() {
	document.getElementById('nlbackground').style.display="block";
	document.getElementById('nlviewer').style.display="block";
	//document.getElementById('nlviewer').src=pdffile;
}

function hidenewsletter() {
	document.getElementById('nlviewer').style.display="none";
	document.getElementById('nlbackground').style.display="none";
}
</script>

<div id="nlviewer" style="position:absolute; top:30px;width:950px;height:600px; left:175px; z-index:999; display:none; " border="1">
    
<iframe src="http://survey.unifocus.com/survey.aspx?SCode=BSQ27" width="100%" height="100%">.

</iframe>

</div>

<div id="nlbackground" style="position:absolute; top:0px; left:0px; z-index:997; display:none; background-color:#000000; opacity:0.7; filter:alpha(opacity=70); width:100%; height:100%;" onclick="hidenewsletter()">
