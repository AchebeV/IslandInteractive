...
$subject = "Island Interactive Comments VI1";
...
// To send HTML mail, the Content-type header must be set
		...
		$headers = 'From: II St. Lucian by Rex Resorts <support@island-interactive.com>' . "\r\n";
...
} else if (substr($media1big, -3)=="pdf" || substr($media1big, -3)=="PDF") {
$admedia1 = '<a href="javascript:;" onclick="showpdf(\''.$adcontenturl.$media1big.'\')"><img src="'.$adcontenturl.$file1.'.'.$ext1.'" border="0" /></a>';
} else if ($itemid=="227146") {
$admedia1 = '<a href="javascript:;" onclick="showvideo(\''.$adcontenturl.'ceitestimonial.flv\')"><img src="'.$adcontenturl.$file1.'.'.$ext1.'" border="0" /></a>';
...
} else if (substr($media2big, -3)=="pdf" || substr($media2big, -3)=="PDF") {
$admedia2 = '<a href="javascript:;" onclick="showpdf(\''.$adcontenturl.$media2big.'\')"><img src="'.$adcontenturl.$file2.'.'.$ext2.'" border="0" /></a>';
...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,0,0','width','800','height','600','id','FLVPlayer','src','FLVPlayer_Progressive','flashvars','&MM_ComponentVersion=1&skinName=Clear_Skin_1&streamName=".$adcontenturl."ceitestimonial&autoPlay=true&autoRewind=false','quality','high','scale','noscale','name','FLVPlayer','salign','lt','pluginspage','http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash','movie','FLVPlayer_Progressive','wmode','transparent' ); //end AC code 
  ...
  <param name=\"scale\" value=\"noscale\" />
  <param name=\"wmode\" value=\"transparent\" />
  <param name=\"FlashVars\" value=\"&MM_ComponentVersion=1&skinName=Clear_Skin_1&streamName=".$adcontenturl."ceitestimonial&autoPlay=true&autoRewind=false\" />
  <embed src=\"FLVPlayer_Progressive.swf\" flashvars=\"&MM_ComponentVersion=1&skinName=Clear_Skin_1&streamName=".$adcontenturl."ceitestimonial&autoPlay=true&autoRewind=false\" quality=\"high\" scale=\"noscale\" width=\"800\" height=\"600\" name=\"FLVPlayer\" salign=\"LT\" type=\"application/x-shockwave-flash\" pluginspage=\"http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash\" wmode=\"transparent\" />
</object></noscript>";
?>
