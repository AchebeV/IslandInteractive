...
<div id="content1" style="position:absolute;left:230px;top:170px;width:528px;height:490px; font-family:Arial, Helvetica, sans-serif; font-size:14px;text-align:justify;">
  ...
  <div id="basicMap" style="height:100%;width:100%;"></div>
...
<script type="text/javascript" src="http://openweathermap.org/js/OWM.OpenLayers.1.3.4.js" ></script>
<script type="text/javascript">
function init() {
	//Center of map
	var lat = 1565500; 
	...
	var lPrecipitation = new OpenLayers.Layer.OWMComposite('PR', "Precipitation forecasts",  {opacity: 0.5} );
	var lClouds = new OpenLayers.Layer.OWMComposite('NT', "Clouds forecasts",  {opacity: 0.5} );
	//Addind maps
	map.addLayers([mapnik, city, lPrecipitation, lClouds]);
