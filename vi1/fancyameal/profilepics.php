...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,0,0','width','800','height','600','id','FLVPlayer','src','FLVPlayer_Progressive','flashvars','&MM_ComponentVersion=1&skinName=Clear_Skin_1&streamName=".$adcontenturl."orlandos&autoPlay=true&autoRewind=false','quality','high','scale','noscale','name','FLVPlayer','salign','lt','pluginspage','http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash','movie','FLVPlayer_Progressive','wmode','transparent' ); //end AC code 
  ...
  <param name=\"scale\" value=\"noscale\" />
  <param name=\"wmode\" value=\"transparent\" />
  <param name=\"FlashVars\" value=\"&MM_ComponentVersion=1&skinName=Clear_Skin_1&streamName=".$adcontenturl."orlandos&autoPlay=true&autoRewind=false\" />
  <embed src=\"FLVPlayer_Progressive.swf\" flashvars=\"&MM_ComponentVersion=1&skinName=Clear_Skin_1&streamName=".$adcontenturl."orlandos&autoPlay=true&autoRewind=false\" quality=\"high\" scale=\"noscale\" width=\"800\" height=\"600\" name=\"FLVPlayer\" salign=\"LT\" type=\"application/x-shockwave-flash\" pluginspage=\"http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash\" wmode=\"transparent\" />
</object></noscript>";
?>
