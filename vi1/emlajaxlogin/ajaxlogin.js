...
document.getElementById('login').style.display='inline'; document.getElementById('loginContainer').style.backgroundImage='URL(images/back_login_new.gif)'; document.getElementById('registerButton').style.display='none'; document.getElementById('loginButton').style.display='none'; document.getElementById('myobj').style.height='596px'; document.getElementById('myobj').style.backgroundImage='URL(images/background_links_new.gif)'; document.getElementById('findoutButton').style.top="524px"; document.getElementById('loginContainer').style.height="150px"; 
...
document.getElementById('login').style.display='none'; document.getElementById('loginContainer').style.backgroundImage='URL(images/back_login.gif)'; document.getElementById('registerButton').style.display='inline'; document.getElementById('loginButton').style.display='inline'; document.getElementById('myobj').style.height='544px'; document.getElementById('myobj').style.backgroundImage='URL(images/background_links.gif)'; document.getElementById('findoutButton').style.top="472px"; document.getElementById('loginContainer').style.height="98px"; 
//document.getElementById('loginButtonNew').style.display="block";
...
document.getElementById('loggedin').style.display='inline'; document.getElementById('loginContainer').style.backgroundImage='URL(images/back_login_new.gif)'; document.getElementById('registerButton').style.display='none'; document.getElementById('loginButton').style.display='none'; document.getElementById('myobj').style.height='596px'; document.getElementById('myobj').style.backgroundImage='URL(images/background_links_new.gif)'; document.getElementById('findoutButton').style.top="524px"; document.getElementById('loginContainer').style.height="150px"; 
//document.getElementById('loginButtonNew').style.display="block";
