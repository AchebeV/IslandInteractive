...
<div id="content1" style="position:absolute;left:230px;top:170px;width:528px;height:490px; font-family:Arial, Helvetica, sans-serif; font-size:14px;text-align:justify;">
  ...
  <div id="uc" style="position:relative;top:0px;left:0px;width:100%;text-align:center;"><br />
	...
	<div style="position:absolute;top:0px;left:0px;width:250px;text-align:center;">
	<img src="images/fidspre_gfl.gif" /><br />
	<br />George F. L. Charles Airport<br />
	<a href="http://common.island-interactive.com/slaspafidsgfla.php?kid=<?php echo $thiskiosknum ?>"><img border="0" src="images/button_arrivals.gif" /></a>&nbsp;&nbsp;&nbsp;<a href="http://common.island-interactive.com/slaspafidsgfld.php?kid=<?php echo $thiskiosknum ?>"><img border="0" src="images/button_departures.gif" /></a> 
	</div>

	<div style="position:absolute;top:0px;left:260px;left:270px;width:250px;text-align:center;">
	<img src="images/fidspre_hia.gif" /><br />
	<br />Hewanorra International Airport<br />
	<a href="http://common.island-interactive.com/slaspafidshiaa.php?kid=<?php echo $thiskiosknum ?>"><img border="0" src="images/button_arrivals.gif" /></a>&nbsp;&nbsp;&nbsp;<a href="http://common.island-interactive.com/slaspafidshiad.php?kid=<?php echo $thiskiosknum ?>"><img border="0" src="images/button_departures.gif" /></a>
	</div>
</div>
<br /><br />
<br />
