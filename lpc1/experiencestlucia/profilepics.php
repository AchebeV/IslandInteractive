...
<a href="javascript:;" onclick="closePop('reviewpop')"><img src="../images/button_close.gif" border="0" style="position:absolute;left:381px;top:13px;"/></a>
...
<div id="taxipop" style="position:absolute;top:160px;left:230px;width:530px;height:460px;display:none; background-image:url(../images/pop_taxi.gif); background-position:center center; background-repeat:no-repeat; ">
	...
	<a href="javascript:;" onclick="closePop('taxipop')"><img src="../images/button_close.gif" border="0" style="position:absolute;left:381px;top:13px;"/></a>
</div>
...
$id=$_GET['id'];
		...
		?>
<a href="http://common.island-interactive.com/gmapget.php?a=<?php echo $id ?>&kid=<?php echo $thiskioskcode ?>" id="map" onclick="showPop(this.id)" ><img src="../images/button_map.gif" alt="Map" name="" width="116" height="40" border="0" id="Image149" style="position:absolute;top:634px;left:654px;"/></a>
