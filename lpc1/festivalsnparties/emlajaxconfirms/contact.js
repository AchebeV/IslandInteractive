...
if (document.getElementById('phone').value=='') {
 alert('Please enter your phone number on island. We will use this to confirm and arrange your bookings.\n\n If you do not have a phone number, please enter the words "Call Desk" and we will contact you at the reception desk.'); return(false);
 }
...
if (document.getElementById('details').value=='') {
 ...
 alert('Please select your accommodation'); return(false);
 }

if (document.getElementById('calltype').value=='taxi') {
	showPopBasic('selecttime');
} else if (document.getElementById('calltype').value=='book') {
	hider();
	document.getElementById('taxipop2').style.display="block";
} else if (document.getElementById('calltype').value=='review') {
	sendConfirm('emlajaxconfirms/ajaxsendconf.php','review',document.getElementById('advertto').value,document.getElementById('kioskcode').value)
}
