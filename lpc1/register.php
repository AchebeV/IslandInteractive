...
<script type="text/javascript" src="emlaccounts/contact.js"></script>
...
<div id="content1" style="position:absolute;left:230px;top:170px;width:528px;height:490px; font-family:Arial, Helvetica, sans-serif; font-size:14px;text-align:justify;">
 ...
 <div style="position:absolute;top:100px;left:27px;color:#000000; font-family:Arial, Helvetica, sans-serif; font-size:12px; font-weight:normal; line-height:20px;"><img id="loader" style="position:absolute;left:-1000px;top:200px;" src="images/loading.gif" />
				<div align="center" id="msg1"></div>
				  ...
				  <table width="500" id="contactTable" border="0" cellspacing="0" cellpadding="5">
					...
					<tr>
                      <td style="text-align:right;"><strong>Hotel:</strong><span style="color:red;">*</span></td>
                      <td><select name="hotel" id="hotel">
						...
						$db2 = mysql_connect("localhost", "islandsupport", "stpecnoc");
								...
								//echo "<option value=\"\"></option>";
									...
									?><option value="La Place Carenage">La Place Carenage</option>
						</select></td>
                    </tr>
                  </table><br />
					<br />
					<div align="center"><input type="button" name="submit" value="Submit" onclick="checkForm()"/></div></form>
...
<!-- <form action="search.php" method="post"><input type="text" name="keywords" id="keywords" style="width:120px;" /><input type="submit" name="submit" value="Search" style="width:60px;"/></form> -->
...
<iframe id="registeriframe" width="0" height="0">
