...
$db = mysql_connect("localhost", "islandsupport", "stpecnoc");
		mysql_select_db("islandsupport",$db);
		$codeget = mysql_query("SELECT * FROM `advertisers` WHERE `section`='$thiscat' ORDER BY `company` ",$db);
...
?>  MM_preloadImages('images/but_inthenewsovr.gif','images/but_lucianpplovr.gif','images/but_ilupdatesovr.gif','images/but_homeovr.gif','images/but_welcomeovr.gif','images/but_newsovr.gif','images/but_loginovr.gif','images/but_registerovr.gif','images/but_learnmoreovr.gif','images/button_nextovr.gif','images/button_backovr.gif');loaderHide();sendstat();">
...
if ($pos === false) { // webserver
    $adcontenturl="http://www.island-interactive.com/dbsyncs/adimages/";
...
<?php //echo $linkurl ?>
    ...
    <div id="rightad1" style="position:absolute;left:12px;top:29px;width:225px;height:125px; border:#000000 solid 0px;"><a href="<?php echo $linkurl ?>explorestlucia/index.php?from=out&shw=303752,903806,508471,347991,574563,263946, , "><img src="<?php echo $adcontenturl ?>RFSR 225 x 125.jpg" alt="Rain Forest Sky Rides" border="0" /></a></div>
...
<div id="rightad2" style="position:absolute;left:12px;top:170px;width:225px;height:125px; border:#000000 solid 0px; background-color:#000000;">
       ...
       <div id="rightad2link" style="position:absolute;left:0px;top:0px;width:225px;height:125px; border:#000000 solid 0px; z-index:999"><a href="<?php echo $linkurl ?>explorestlucia/index.php?from=out&shw=183371, , , "><img src="<?php echo $adcontenturl ?>tparentcover.jpg" border="0" /></a></div>
   
	</div>
    
  <div id="rightad3" style="position:absolute;left:12px;top:311px;width:225px;height:125px; border:#000000 solid 0px;"><a href="<?php echo $linkurl ?>letsgoshopping/index.php?from=out&shw=921052, , , "><img src="<?php echo $adcontenturl ?>BWSM 225 x 125.jpg" alt="Baywalk Shopping Mall" border="0" /></a></div>
    
    <div id="rightad4" style="position:absolute;left:12px;top:452px;width:225px;height:125px; border:#000000 solid 0px;"><img src="<?php echo $adcontenturl ?>adholder 225 x 125.jpg" alt="Advertise" border="0" /></div>
    
    <div id="rightad5" style="position:absolute;left:12px;top:593px;width:225px;height:125px; border:#000000 solid 0px;"><img src="<?php echo $adcontenturl ?>adholder 225 x 125.jpg" alt="Advertise" border="0" /></div>
...
<a href="javascript:;" onmouseout="MM_swapImgRestore()"onmouseup="MM_swapImgRestore()" onmousedown="MM_swapImage('Image3','','images/but_homeovr.gif',1)" onclick="start();moverHome();return false;"><img src="images/but_home.gif" alt="Welcome" name="Image3" width="188" height="69" border="0" id="Image3" style="position:absolute;left:0px;top:4px;"/></a>

<a href="index.php" onmouseout="MM_swapImgRestore()"onmouseup="MM_swapImgRestore()" onmousedown="MM_swapImage('Image4','','images/but_newsovr.gif',1)"><img src="images/but_news.gif" alt="News &amp; Updates" name="Image4" width="188" height="69" border="0" id="Image4" style="position:absolute;left:0px;top:48px;" /></a>

<a href="inthenews.php" onmouseout="MM_swapImgRestore()"onmouseup="MM_swapImgRestore()" onmousedown="MM_swapImage('Image5','','images/but_inthenewsovr.gif',1)"><img src="images/but_inthenews.gif" alt="In the News" name="Image5" width="188" height="69" border="0" id="Image5" style="position:absolute;left:0px;top:92px;" /></a>

<a href="updates.php" onmouseout="MM_swapImgRestore()"onmouseup="MM_swapImgRestore()" onmousedown="MM_swapImage('Image6','','images/but_ilupdatesovr.gif',1)"><img src="images/but_ilupdates.gif" alt="Island Interactive Updates" name="Image6" width="188" height="69" border="0" id="Image6" style="position:absolute;left:0px;top:136px;"/></a>

<a href="people.php" onmouseout="MM_swapImgRestore()"onmouseup="MM_swapImgRestore()" onmousedown="MM_swapImage('Image7','','images/but_lucianpplovr.gif',1)"><img src="images/but_lucianppl.gif" alt="Lucian People" name="Image7" width="188" height="69" border="0" id="Image7" style="position:absolute;left:0px;top:180px;"/></a>
...
new fadeshow(fadeimages, 629, 120, 0, 3000, 0, "R")
...
<div id="itemcontent" style="position:absolute;left:230px;top:170px;width:528px;height:490px; font-family:Times New Roman, Times, serif; font-size:14px;text-align:justify;">
...
$db = mysql_connect("localhost", "islandsupport", "stpecnoc");
	 ...
	 for ($i=1; $i<=$numpages; $i++) {
		...
		echo '<div id="content'.$i.'" style="position:absolute;top:80px;left:-2000px;width:100%;">';
		
		$thispagestart=$i*4-4;
		$topstart=0;
			
		if (isset($_GET['shw'])) {
			$codeget = mysql_query("SELECT * FROM `advertisers` WHERE `id`='".$itemsshow[$thispagestart]."' || `id`='".$itemsshow[$thispagestart+1]."' || `id`='".$itemsshow[$thispagestart+2]."' || `id`='".$itemsshow[$thispagestart+3]."' ORDER BY `company`",$db);
		} else {
		...
		echo '<a href="profilepics.php?id='.$itemid.'&bp=index" style="text-decoration:none;color:black;" onmousedown="style.color=\'#CC0000\'" onmouseup="style.color=\'#000000\'"><div id="item'.$j.'" style="position:absolute;top:'.$topstart.'px;left:0px;width:100%;height:100px;"><div style="position:absolute;top:0px;left:0px;"><a href="profilepics.php?id='.$itemid.'&bp=index" style="text-decoration:none;color:black;" onmousedown="style.color=\'#CC0000\'" onmouseup="style.color=\'#000000\'"><img border="0" src="'.$adcontenturl.$image1.'" width="140" height="85" /></a></div><a href="profilepics.php?id='.$itemid.'&bp=index" style="text-decoration:none;color:black;" onmousedown="style.color=\'#CC0000\'" onmouseup="style.color=\'#000000\'"><div style="position:absolute;top:0px;left:150px; line-height:12px;"><img border="0" src="images/stars.gif" /><strong> - '.$name.'</strong><br /><span style=" font-size:10px;">Not Yet Rated</span></div><div style="position:absolute;top:35px;left:150px;">Email: '.$email.'&nbsp;&nbsp;&nbsp;Phone: '.$phone.'<br>Address: '.$address.'  </div></div></a></a>';
...
<div style="position:absolute;top:200px;left:791px; font-family:Arial, Helvetica, sans-serif; font-weight:normal; font-size:14px;">Need Help? Call (758) 285-3384</div>
...
<div id="comingsoon" style="position:absolute;top:264px;left:240px;width:510px;height:150px;display:none; background-image:url(images/msgpopback.gif); background-position:center center; background-repeat:no-repeat; text-align:center;">
	<strong><br>Thank you for using this demo version of the Island Interactive Service.<br><br>This Feature will be coming soon.</strong><br><br><a href="javascript:;" onclick="closePop('comingsoon')"><img src="images/button_close.gif" border="0" /></a>
</div>
