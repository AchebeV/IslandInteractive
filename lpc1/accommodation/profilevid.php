...
<div id="content1" style="position:absolute;left:230px;top:170px;width:528px;height:490px; font-family:Times New Roman, Times, serif; font-size:14px;text-align:justify;">
	  	
	<div id="itemcontent" style="position:absolute;top:0px;left:0px;width:100%;">
	
	<div id="item1" style="position:relative;top:0px;left:0px;width:100%;height:155px;">
	  <script type="text/javascript">
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0','width','530','height','250','src','index','quality','high','pluginspage','http://www.macromedia.com/go/getflashplayer','movie','index' ); //end AC code
	...
	<div id="text2" style="position:absolute;top:280px;left:-10px;width:528px;height:120px;border:0px solid black;margin:10px; font-family:Arial, Helvetica, sans-serif; font-size:12px; text-align:justify;">
	Teatsgf ajdfhkjasdf ksdhf kjsdhhd fjh jfjshfkjh fhajf kjahsd js s djk dhasjgkaJGDA KDFG KJSADJ LHUIHSHF KJH JK KJH KJSH JKSHFJ HSFG Ssjskjhkjhfjgh jghh  js hsh kjshf kjshf kjsh jshf jsh fkjshf jksdhfjk sdfoiwufhsfh slh ls hgdlsjkgh ldgh 
	Teatsgf ajdfhkjasdf ksdhf kjsdhhd fjh jfjshfkjh fhajf kjahsd js s djk dhasjg kaJGDA KDFGKJ SADJL HUIHSHF KJH JK KJH KJSH JKSHFJ HSFG Ssjskjhkj hfjgh jghh  js hsh kjshf kjshf kjsh jshf jsh fkjshf jksdhfjksdf oiwufhsfh slh ls hgdlsjkgh ldgh Teatsgf ajdfhkjasdf ksdhf kjsdhhd fjh jfjshfkjh fhajf kjahsd js s djk dh asjgkaJ GDAK FGKJSAD  JLHUIHSHF KJH JK KJH K
	</div>
...
<div id="bookpop" style="position:absolute;top:160px;left:230px;width:530px;height:460px;display:none; background-image:url(../images/pop_book.gif); background-position:center center; background-repeat:no-repeat; "><a href="javascript:;" onclick="closePop('bookpop')"><img src="../images/button_close.gif" border="0" style="position:absolute;left:381px;top:13px;"/></a></div>

<div id="reviewpop" style="position:absolute;top:160px;left:230px;width:530px;height:460px;display:none; background-image:url(../images/pop_review.gif); background-position:center center; background-repeat:no-repeat; "><a href="javascript:;" onclick="closePop('reviewpop')"><img src="../images/button_close.gif" border="0" style="position:absolute;left:381px;top:13px;"/></a></div>

<div id="taxipop" style="position:absolute;top:160px;left:230px;width:530px;height:460px;display:none; background-image:url(../images/pop_taxi.gif); background-position:center center; background-repeat:no-repeat; "><a href="javascript:;" onclick="closePop('taxipop')"><img src="../images/button_close.gif" border="0" style="position:absolute;left:381px;top:13px;"/></a></div>


<a href="javascript:;" id="taxi" ><img src="../images/button_taxi.gif" alt="Taxi" name="" width="116" height="40" border="0" id="Image149" style="position:absolute;top:634px;left:221px;"/></a>

<a href="javascript:;" id="map"  ><img src="../images/button_map.gif" alt="Map" name="" width="116" height="40" border="0" id="Image149" style="position:absolute;top:634px;left:654px;"/></a>


<a href="javascript:;" onmouseout="MM_swapImgRestore()" onmouseup="MM_swapImgRestore()" onmousedown="MM_swapImage('Image14','','../images/button_backovr.gif',1)"><img src="../images/button_back.gif" alt="Back" name="Image14" width="116" height="40" border="0" id="Image14" style="position:absolute;top:679px;left:221px;"/></a>

<a href="javascript:;" onmouseout="MM_swapImgRestore()" onmouseup="MM_swapImgRestore()" onmousedown="MM_swapImage('Image13','','../images/button_nextovr.gif',1)"><img src="../images/button_next.gif" alt="Next" name="Image13" width="115" height="40" border="0" id="Image13" style="position:absolute;top:679px;left:654px;"/></a>
