...
$db = mysql_connect("localhost", "islandsupport", "stpecnoc");
		...
		$codeget = mysql_query("SELECT * FROM `Text_Only_Profile` WHERE `id`='$id'",$db);
...
<div id="content1" style="position:absolute;left:230px;top:170px;width:528px;height:490px; font-family:Times New Roman, Times, serif; font-size:14px;text-align:justify;">
	...
	<div id="text1" style="position:absolute;top:10px;left:-10px;width:528px;height:400px;border:0px solid black;margin:10px; font-family:Arial, Helvetica, sans-serif; font-size:12px; text-align:justify; border:0px solid black">
	<?php echo $text1 ?>
	</div>
...
<a href="javascript:;" id="map" onclick="showPop(this.id)" ><img src="../images/button_map.gif" alt="Map" name="" width="116" height="40" border="0" id="Image149" style="position:absolute;top:634px;left:654px;"/></a>
...
<a href="javascript:;" onmouseout="MM_swapImgRestore()" onmouseup="MM_swapImgRestore()" onmousedown="MM_swapImage('Image14','','../images/button_plainovr.gif',1)"><img src="../images/button_plain.gif" alt="Back" name="Image14" width="116" height="40" border="0" id="Image14" style="position:absolute;top:679px;left:221px;"/></a>

<a href="javascript:;" onmouseout="MM_swapImgRestore()" onmouseup="MM_swapImgRestore()" onmousedown="MM_swapImage('Image13','','../images/button_plainovr.gif',1)"><img src="../images/button_plain.gif" alt="Next" name="Image13" width="115" height="40" border="0" id="Image13" style="position:absolute;top:679px;left:654px;"/></a>
