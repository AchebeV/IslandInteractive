...
<img src="slhta_placeholder.gif" />
  
    
    

   <!-- <iframe id="pdfviewer" style="position:absolute; top:0px; left:0px; z-index:999; display:none;overflow:auto;" width="548" height="570" border="0" type="application/pdf">
...
showpdf('SLHTANewsletterCurrent.pdf');
</script> -->
...
<script type="text/javascript">
function shownewsletter(nlfile) {
...
<div id="nlviewer" style="position:absolute; top:30px; left:175px; z-index:999; display:none; " width="950" height="600" border="1">

	 
    <div align="center" style="height:600px; width:900px; overflow:auto;">
    <?php 
	$nlget = mysql_query("SELECT * FROM `slhta_newsletters` WHERE `id`=1",$db);
		while ($myrow2 = mysql_fetch_row($nlget)) {
				$html=$myrow2[1];
		}
		echo $html; 
	?>
